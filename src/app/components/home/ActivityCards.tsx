// src/components/home/ActivityCards.tsx - CARDS ANCHOS CON TAG EXACTO
'use client'
...
const ActivityCards = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth >= 1280) {
        setCardsPerView(3);  // Más ancho - muestra 2.5 cards
      } else if (window.innerWidth >= 1024) {
        setCardsPerView(2);  // Más ancho - muestra 1.8 cards
      } else if (window.innerWidth >= 768) {
        setCardsPerView(1);  // Más ancho - muestra 1.3 cards
      } else {
        setCardsPerView(1);
      }
    };
  ...
  // Color verde uniforme para todos los paquetes
  const greenTheme = {
    taglineBg: '#4169E1',
    taglineFold: '#2c4a9e', // Color más oscuro para el triángulo de doblez
    priceColor: '#4CAF50',
    buttonColor: '#2D6A4F',
    buttonHover: '#1f4930'
  };
  ...
  const packages = [
    ...
    },
    {
      ...
      description: 'Feel the rush! Fly through the canopy and conquer the heights with our thrilling Sky Trek + Arboreal Challenge Course package — perfect for adrenaline seekers.',
      price: '$139',
      image: '/images/activities/canopy.jpg',
      activityTags: [
        { name: 'skytrek', color: '#E74C3C' },
  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 max-w-[1650px]">
        {/* Header */}
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Discover all the experiences we have prepared for you and your family at Jungle Breezes.
          </p>
        </div>
            ...
            <div className="overflow-hidden">
              ...
              >
                {packages.map((pkg) => (
                  ...
                  >
                    {/* Card con bordes superiores redondeados */}
                    <div className="bg-white rounded-t-xl shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col" style={{ overflow: 'visible', minHeight: '750px' }}>
                      ...
                      <div className="relative h-[340px]" style={{ overflow: 'visible', borderTopLeftRadius: '0.75rem', borderTopRightRadius: '0.75rem' }}>
                        ...
                        {/* Tagline con triángulo de doblez - BIEN SALIDA DEL CARD */}
                        <div className="absolute top-4 z-10" style={{ left: '-28.5px' }}>
                          {/* Triángulo pequeño oscuro (doblez) - DEBAJO DEL TAG */}
                          <div 
                            className="absolute left-0 z-0"
                            style={{
                            bottom: '-8px', left: 15.8,
                              width: 0,
                              height: 0,
                          ...
                          {/* Etiqueta principal - ENCIMA - MÁS FINA */}
                          <div 
                      ...
                      <div className="p-6 flex-1 flex flex-col">
                        ...
                        {/* Price - DEBAJO DEL TÍTULO - CENTRADO */}
        ...
        <div className="text-center mt-16">
          <p className="text-base text-gray-600 mb-3">
            Can't find what you're looking for? We can create a custom package for you.
          </p>
          <Link 
            href="/contact"
